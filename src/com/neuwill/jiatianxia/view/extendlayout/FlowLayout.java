...
public class FlowLayout extends ViewGroup {
    ...
    public void setLineSpacing(int width){
    	this.lineSpacing = width;
    }
    ...
    public void showDelete(){//显示所有view的删除图标
  		Log.d("print","showDelete");
  		for(int i=0;i<this.getChildCount()-1;i++){
  			Single single=(Single) this.getChildAt(i);
  			single.showDeleteImage();
//  			single.setSlecteIsShow();
  		}
  	}
}
